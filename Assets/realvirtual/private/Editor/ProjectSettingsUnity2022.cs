    ...
    public static class ProjectSettingsUnity2022
    {
        ...
        public static void SetupURPRenderer()
        {
            try
            {
                ...
                var unity2022PipelineExists = AssetDatabase.LoadAssetAtPath<UniversalRenderPipelineAsset>(
                    "Assets/realvirtual/RenderPipelines/Resources/URP/URP-DefaultUnity2022.asset") != null;
                    
                if (unity2022PipelineExists)
                {
                    Logger.Message("Unity 6 detected: Full URP renderer features available. " +
                        "Use 'realvirtual/Settings/Use Unity 2022 Compatible Renderer' to test compatibility.", null);
                }
#endif
            }
            catch (Exception e)
        ...
        public static void SwitchToUnity2022Renderer()
        {
            ...
            UnityEngine.Rendering.GraphicsSettings.renderPipelineAsset = unity2022Pipeline;
        ...
        public static void SwitchToUnity6Renderer()
        {
            ...
            UnityEngine.Rendering.GraphicsSettings.renderPipelineAsset = unity6Pipeline;
        ...
        /// <summary>
        /// Test method to debug URP renderer switching
        /// </summary>
        [UnityEditor.MenuItem("realvirtual DEV/Debug/Test Unity 2022 Renderer Switch")]
        public static void TestUnity2022RendererSwitch()
        {
            Logger.Message("=== Testing Unity 2022 Renderer Switch ===", null);
            SetupURPRenderer();
            Logger.Message("=== Test Complete ===", null);
        }
