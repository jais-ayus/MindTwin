...
namespace realvirtual
{
    public static class MeshCombine 
    {
        ...
        public static GameObject CombineToNewGoAndKeep(GameObject gobject, MeshFilter[] meshfilters)
        {
            ...
            CombineMeshesWithMutliMaterial(newGo, false, meshfilters,newGo.name,true, ref DeactivatedRenderers);
            
            
            // destroy all deactivated
            foreach (var meshRenderer in DeactivatedRenderers)
            {
        ...
        public static GameObject CombineMeshesAndDestroy(GameObject gobject, MeshFilter[] meshfilters)
        {
            #if UNITY_EDITOR
            // Register Undo for the GameObject and its components
            Undo.RegisterCompleteObjectUndo(gobject, "Combine Meshes");
            Undo.RegisterCompleteObjectUndo(gobject.transform, "Combine Meshes");
            foreach (var meshFilter in meshfilters)
            {
                Undo.RegisterCompleteObjectUndo(meshFilter.gameObject, "Combine Meshes");
            }
