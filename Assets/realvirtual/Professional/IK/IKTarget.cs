...
namespace realvirtual
{
    ...
    //! This professional component represents waypoints in robotic paths with configurable interpolation modes,
    //! speed parameters, and signal coordination. Supports linear and point-to-point motion, axis corrections,
    //! and integration with pick-and-place operations for comprehensive robotic programming in automation systems.
    public class IKTarget : BehaviorInterface
    {
        ...
        [Header("Right Handed Robot Coordinates")] [ReadOnly]
        public Vector3 PosRH; //!< Position of the target in right handed robot coordinates
        
        [ReadOnly] public Vector3 RotRH; //!< Rotation of the target in right handed robot coordinates
        ...
        [ReadOnly]public Vector3 PositionCorrection = new Vector3(0, 0, 0); //!< Correction of the position (because of inaccuracies of the robotik)
        [ReadOnly]public float PositionFailure = 0;//!< Position failure in m
        ...
        public bool PickAndPlace; //!< Wait for signal after target is reached
        [ShowIf ("PickAndPlace")] public Fixer fixer;
        [ShowIf ("PickAndPlace")] public bool Pick; 
        [ShowIf ("PickAndPlace")] public bool Place;
        [Header("Control")] [Range(0, 7)] public int Solution; //!< Solution to use of the IK for this target
        [ReadOnly] public string[] Solutions = new string[8]; //!< Solutions of the IK for this target
        [ReadOnly] public float[] AxisPos = new float[6];//!< Axis positions of the IK for this target
        [ReadOnly] public RobotIK RobotIK; //!< Robot IK of the robot
        [ReadOnly] public bool Reachable; //!< If true the target is reachable by the robot


        private bool waitforsignalnotnull;
        private bool setsignalnotnull;
        private bool fixernotnull;
