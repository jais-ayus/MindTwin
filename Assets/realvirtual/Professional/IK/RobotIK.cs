...
namespace realvirtual
{
    ...
    //! This professional component enables precise robot control through inverse kinematics calculations, supporting
    //! multiple IK solutions, TCP management, and seamless integration with drive systems. Used for virtual commissioning
    //! of robotic cells, path validation, and cycle time optimization in industrial automation scenarios.
    public class RobotIK : realvirtualBehavior
    {
        ...
        private void PositionDrives()
        {
            ...
            if (Application.isPlaying)
            {
                ...
                Axis[0].SetPosition((float) (iksolution[Solution, 0]));
                Axis[1].SetPosition((float) (iksolution[Solution, 1]));
                Axis[2].SetPosition((float) (iksolution[Solution, 2]));
                Axis[3].SetPosition((float) (iksolution[Solution, 3]));
                Axis[4].SetPosition((float) (iksolution[Solution, 4]));
                Axis[5].SetPosition((float) (iksolution[Solution, 5]));
            }
            else
            {
